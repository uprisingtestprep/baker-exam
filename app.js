/* BAKER Exam Simulator, Application Logic */

const ACCESS_CODE  = "BAKER9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "baker_exam_state_v1";
...
const DOMAIN_LABELS = {"common_occupational_skills": "Common Occupational Skills", "fermented_goods": "Fermented Goods", "cookies_bars_quick_breads_pastry_doughs_and_cakes": "Cookies Bars Quick Breads Pastry Doughs and Cakes", "assembly_and_finishing": "Assembly and Finishing", "chocolate_confections_and_sugar_work": "Chocolate Confections and Sugar Work", "desserts_ice_creams_and_ices": "Desserts Ice Creams and Ices"};  // maps domain key -> human-readable label for display
